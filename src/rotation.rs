...
impl Rotation {
    ...
    pub fn compose(&self, other: &Rotation) -> Rotation {
        let mut res = Rotation{el: Default::default()};
...
mod test {
    ...
    #[test]
    fn test_combine() {
        const ROTATIONS: [Rotation; 4] = [Rotation::identity(), Rotation::rot_x(), Rotation::rot_y(), Rotation::rot_z()];
	const VECTORS: [Vector; 3] = [Vector::new(1,0,0), Vector::new(0,1,0), Vector::new(0,0,1)];
